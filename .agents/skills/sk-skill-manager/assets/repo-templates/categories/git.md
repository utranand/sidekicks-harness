...
Branches, worktrees, shipping, sweeps, release notes.

Repository mechanics: cutting and integrating sibling worktrees, shipping a finished change, sweeping stale branches, and generating release notes from real history.
