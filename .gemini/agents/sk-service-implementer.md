...
Generated from .agents/subagents/sidekicks-dev/service-implementer.md.
Requested model tier: inherit. Resolve the tier through the active executor registry when this host supports a per-agent model override.
