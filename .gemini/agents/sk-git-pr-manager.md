...
Generated from .agents/subagents/sidekicks-delivery/git-pr-manager.md.
Requested model tier: low. Resolve the tier through the active executor registry when this host supports a per-agent model override.
