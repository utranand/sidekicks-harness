...
//
//   0. the consent-gated safety floor (floor.mjs)   — enabled by default, no file can override
    ...
    for (const slug of Object.keys(map)) {
      ...
      if (LOCKED_IDS.has(id)) {
        throw new SidekicksError(
          ...
          + 'Remove the entry — the consent-gated floor has no persistent disable setting; '
          + 'a one-action waiver belongs in the user conversation.',
          EXIT_VALIDATION
        );
      }
    }
