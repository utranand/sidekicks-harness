 ...
 *
 * @param {string} repoRoot
 * @param {string|null} [config] - one repo-relative config to scan; omitted scans every supported
 *                                 host port and returns their union
 * @returns {string[]} sorted, de-duplicated
 */
export function wiredHookScripts(repoRoot, config = null) {
  const found = new Set();
  for (const rel of config ? [config] : HOOK_CONFIGS) {
