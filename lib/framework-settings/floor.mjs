...
export const LOCKED_IDS = Object.freeze(new Set([
  ...
  // Production access. Two DISTINCT rules: the Teleport-only routing rule, and
  // sk-cluster-ops' own "hard-stops on prod — never override" clause.
  'rule.teleport-prod-access',
  'rule.cluster-ops-prod-hardstop',
