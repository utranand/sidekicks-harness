...
export const CORE_HOOKS = Object.freeze([
  ...
  {
    id: 'hook.rtk',
    script: '.sidekicks/hooks/rtk-hook.mjs',
 ...
 * by merely existing, and seven floor rules (the prod-access routing rule, the cluster-ops hard stop,
...
export const CORE_RULES = Object.freeze([
  ...
  // ── Floor: hard stops with owning skills, body stays in AGENTS.md ──────────
  {
    ...
    title: 'Production access — direct allowed, Teleport as fallback',
    owners: [
    ...
    marker: 'Production access — direct allowed, Teleport as fallback',
  },
  {
  ...
  { id: 'rule.protected-branches',            title: 'Protected-branch writes require explicit waiver', owners: [], marker: 'Protected branches — explicit waiver required' },
  ...
  { id: 'rule.plan-first',               title: 'Enter plan mode before implementation', owners: ['sk-bmad-developer', 'sk-implementation-planner', 'sk-jira-autopilot', 'sk-get-plan-done', 'sk-framework-dev', 'sk-bmad-pm'], marker: 'Plan-first — enter plan mode before implementation' },
  ...
  { id: 'rule.lean-main-merge',          title: 'Land tested work on main via the leanest safe path', owners: [], marker: 'Landing already-tested work on `main` — leanest safe path' },
