...
const REWRITES = Object.freeze([
  ...
  // env-var-anchored on Claude/Gemini (like every other hook in those files) and workspace-relative
  ...
  [/(\$(?:CLAUDE|GEMINI|AGENT)_PROJECT_DIR)\/\.sidekicks\/hooks\//g, `$1/${CORE_DIR}/.sidekicks/hooks/`],
