 ...
 *
 * `dangling-reference` is dropped OUTSIDE a source tree only (see below): its subjects are
 * `lib/**` dispatch modules and skill defaults files, which exist in the framework source repo and
 * legitimately do not in a consumer workspace or a mounted-core workspace, where the framework lives
 * at .sidekicks-core/ instead.
 */
