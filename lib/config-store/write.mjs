...
/**
 * The full `config/.gitignore` a fresh configuration directory gets.
 *
 * Exported because `project link` seeds a directory that may live entirely OUTSIDE this repo, where
 * `ensureSecretIgnore`'s write guard (correctly) refuses — that call site writes it directly, and the
 * content must not be a second copy that drifts from this one.
 */
export const SECRET_IGNORE_FILE = [
