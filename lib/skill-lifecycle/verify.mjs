...
const INTEGRITY_CHECKS = Object.freeze(new Set([
  ...
  // A recorded exec bit that is not on disk. Integrity, not omission: the manifest already made
  // the claim, and a script that cannot run is broken in exactly the way this verb grades.
  'mode-drift',
]));
